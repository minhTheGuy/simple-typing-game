          ...
          <div class="text-green-200">
            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
              ...
              <path fill-rule="evenodd"
                d="M4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm8 3a1 1 0 10-2 0v.01a1 1 0 102 0V8zm-3 3a1 1 0 10-2 0v.01a1 1 0 102 0V11zm-1 2a1 1 0 011-1v.01a1 1 0 11-2 0V12a1 1 0 011-1z"
                clip-rule="evenodd" />
            </svg>
          </div>
        </div>
